...
class Profesor(models.Model):
    ...
    institucion = models.ForeignKey('institucion.Institucion', on_delete=models.CASCADE, default=1)  # Id de la institucion del profesor
    img_perfil = models.ImageField(upload_to='profesores_uploads/', blank=True, null=True, default='Profesores/ProfesorDefault.jpeg')
